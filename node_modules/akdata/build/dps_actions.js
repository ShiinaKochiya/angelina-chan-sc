...
var Actions = {
    ...
    char_355_ethan: {
        extraDamage: function () {
            if (this.skillId == "skchr_ethan_1") {
                ...
                var p = this.attr.calcDamagePool(this.char.blackboard["attack@poison_damage"], this.rotation.duration * this.attr.finalEnemy.count, 1);
    ...
    skchr_amgoat_2: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.finalFrame.atk / 2, (this.enemy.count - 1) * this.rotation.attackCount);
        }
    },
    skchr_amiya2_2: {
    ...
    skchr_ayer_2: {
        extraDamage: function (args) {
            ...
            return this.attr.calcDamagePool(args.finalFrame.atk_noscale * args.blackboard.atk_scale, this.enemy.count * this.rotation.attackCount, 1);
        }
    },
    skchr_beewax_2: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.finalFrame.atk * args.blackboard.atk_scale, args.enemy.count);
        }
    },
    skchr_bluep_2: {
        hitCount: function () {
    ...
    skchr_blemsh_1: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.finalFrame.atk_noscale * args.blackboard.heal_scale, this.hitCount, 2);
        }
    },
    skchr_blemsh_2: {
        extraDamage: function (args) {
    ...
    skchr_blemsh_3: {
        extraDamage: function (args) {
            var arts = this.attr.calcDamagePool(args.finalFrame.atk_noscale * args.blackboard["attack@blemsh_s_3_extra_dmg[magic].atk_scale"], this.hitCount, 1);
            var heal = this.attr.calcDamagePool(args.finalFrame.atk_noscale * args.blackboard.heal_scale, this.hitCount, 2);
            if (this.options.cond)
                this.log.note("额外法伤享受睡眠增伤");
    ...
    skchr_breeze_2: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.finalFrame.atk / 2, (this.enemy.count - 1) * this.rotation.attackCount, 2);
        }
    },
    ...
    skchr_cgbird_2: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.finalFrame.atk * args.blackboard.atk_scale, this.hitCount, 4);
        }
    },
    skchr_chen_2: {
        extraDamage: function (args) {
    ...
    skchr_folnic_2: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.finalFrame.atk_noscale * this.attr.buffFrame.heal_scale, this.hitCount, 2);
        }
    },
    ...
    skchr_huang_3: {
        ...
        extraDamage: function (args) {
            var p = this.attr.calcDamagePool(args.finalFrame.atk_noscale * args.blackboard.damage_by_atk_scale, this.enemy.count);
    ...
    skchr_ifrit_2: {
        extraDamage: function (args) {
            var damage = this.attr.calcHitDamage(args.finalFrame.atk_noscale * args.blackboard["burn.atk_scale"]);
    ...
    skchr_nightm_1: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(this.hitDamage * this.attr.buffFrame.heal_scale, Math.min(this.enemy.count, args.blackboard["attack@max_target"]) * this.rotation.attackCount, 2);
        }
    },
    skchr_nightm_2: {
        extraDamage: function (args) {
    ...
    skchr_peacok_1: {
        applyBuff: function (attr, blackboard) {
            if (attr.crit)
                blackboard.atk_scale = blackboard.atk_scale_fake;
            return { done: false };
        }
    },
    skchr_peacok_2: {
    ...
    skchr_rosmon_1: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.finalFrame.atk_noscale * args.blackboard.extra_atk_scale, this.hitCount, 1);
        }
    },
    skchr_rosmon_3: {
        applyBuff: function (attr, blackboard) {
    ...
    skchr_sddrag_2: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.finalFrame.atk * args.blackboard["attack@skill.atk_scale"], this.hitCount, 1);
        }
    },
    skchr_shining_2: {
        extraDamage: function (args) {
    ...
    skchr_tomimi_2: {
        ...
        extraDamage: function (args) {
            ...
            return this.attr.calcDamagePool(args.finalFrame.atk, (args.enemy.count - 1) * this.critHitCount, 0);
        }
    },
    ...
    tachr_180_amgoat_2: {
        rotation_startSp: function (args) {
    ...
    tachr_181_flower_1: {
        extraDamage: function (args) {
            ...
            return this.attr.calcDamagePool(args.blackboard.atk_to_hp_recovery_ratio * args.finalFrame.atk, this.rotation.duration * args.enemy.count);
        }
    },
    tachr_185_frncat_1: {
        applyBuff: function (attr, blackboard) {
    ...
    tachr_2013_cerber_1: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.blackboard.atk_scale * args.enemy.def, this.hitCount, 1);
        }
    },
    tachr_204_platnm_1: {
        applyBuff: function (_, blackboard) {
    ...
    tachr_225_haak_1: {
        ...
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.hpratio * args.finalFrame.maxHp * this.critAttr.buffFrame.heal_scale, this.critHitCount, 2);
        }
    },
    ...
    tachr_311_mudrok_1: {
        extraDamage: function (args) {
            return this.attr.calcDamagePool(args.hpratio * args.finalFrame.maxHp, this.rotation.totalDuration / args.blackboard.interval, 2);
        }
    },
    ...
    tachr_346_aosta_1: {
        extraDamage: function (args) {
            ...
            if (this.skillId == "skchr_aosta_2" && this.flags.skill)
                damage *= this.buffList["skchr_aosta_2"].talent_scale;
            var total = damage * this.rotation.duration * args.enemy.count;
            this.writeBuff(`每秒毒伤: ${damage.toFixed(1)}`);
            return { pool: [0, total, 0, 0, 0] };
        }
    ...
    tachr_391_rosmon_trait: {
        extraDamage: function (args) {
            var n = 1;
            if (this.flags.skill && this.skillId == "skchr_rosmon_2")
                n = 3;
            this.writeBuff(`余震次数 ${n}`);
            return this.attr.calcDamagePool(args.finalFrame.atk_noscale * args.blackboard["attack@append_atk_scale"], this.hitCount * n, 0);
        }
    },
    tachr_400_weedy_2: {
        normal_duration: function (args) {
        ...
        extraDamage: function (args) {
            ...
            if (!this.options.cond) { // 不选触发天赋时，只计算治疗导致的持续回血
                ...
                if (this.skillId == "skchr_whispr_2")
                    effectTime = Math.min(this.buffList["skchr_whispr_2"]["attack@status_resistance[limit]"], this.rotation.attackTime);
